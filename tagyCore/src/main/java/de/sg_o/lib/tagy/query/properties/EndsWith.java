...
public class EndsWith extends QueryProperty {
    private final @NotNull de.sg_o.lib.tagy.db.QueryProperty<TagContainer> queryProperty;

    public EndsWith(TagDefinition tagDefinition, @NotNull String value) {
        super(tagDefinition);
        this.queryProperty = () -> TagContainer_.stringValue.endsWith(value, QueryBuilder.StringOrder.CASE_SENSITIVE);
    }
