...
class TagLongTest {
    ...
    void addToDocument() {
        ...
        assertEquals("{\"value\":1}", json0);
        assertEquals("{\"value\":1}", json1);
        assertEquals("{\"value\":2}", json2);
        assertEquals("{\"value\":2}", json3);
        assertEquals("{\"value\":1}", json4);
    ...
    void testEquals() {
        ...
        assertEquals(1124356374, tag0.hashCode());
        assertEquals(960036086, tag1.hashCode());
        assertEquals(1124356375, tag2.hashCode());
        assertEquals(960036087, tag3.hashCode());
